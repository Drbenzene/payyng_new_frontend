...
import { Currency, cableTVProviders } from "@/constants/constantValues";
...
function Page() {
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <p className="text-2xl font-semibold text-gray-800">Cable TV</p>
      <p className="text-gray-500 mt-2">Renew your cable TV subscription</p>
                ...
                >
                  <div className="mb-2">
                    ...
                    <div className="grid grid-cols-4 gap-2 mb-5 mt-2">
                      {cableTVProviders.map((item, index) => (
                        <div
                          key={index}
                  ...
                  {processingBouquets && <BillsPaymentSkeleton />}
                  {bouquets && (
                    <div>
                      <PayyngInput
                        inputType="SELECT"
