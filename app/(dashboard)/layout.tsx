...
const navigation = [
  ...
  // { name: "Crypto", href: "/crypto", icon: TbCoinBitcoin },
  {
    name: "Gift Card",
    href: "/gift-card",
    icon: HiGiftTop,
...
const mobileNavigation = [
  { name: "Home", href: "/overview", icon: SiHomeadvisor },
  { name: "Accounts", href: "/accounts", icon: RiBankLine },
  {
    name: "Bills",
    href: "/bills",
  ...
  return (
    <>
      <div className="">
        ...
        <div className="fixed mt-60 inset-x-0 bottom-0 z-50 flex justify-center bg-white border-t border-gray-200 lg:hidden">
          <nav className="flex items-center justify-around w-full max-w-md p-2">
...
// <main className="py-10 bg-onboarding min-h-screen bg-blend-overlay bg-gray-100">
